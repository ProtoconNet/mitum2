...
func TestLocalParamsJSON(tt *testing.T) {
	...
	t.Compare = func(a, b interface{}) {
		...
		t.Equal(ap.waitPreparingNextRoundINITBallot, bp.waitPreparingNextRoundINITBallot)
...
func TestLocalParamsJSONMissing(tt *testing.T) {
	...
	p.SetWaitPreparingNextRoundINITBallot(p.WaitPreparingNextRoundINITBallot() + 3)
